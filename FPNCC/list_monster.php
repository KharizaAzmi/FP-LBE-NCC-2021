...
<html lang="en">
  <head>
    ...
    <title>Tabel Monster Genshin Impact</title>
    <style>
      body{
        background: #8360c3;  
  ...
  <div class="header">
    <div class="search">
      <form action="search_monster.php" method="post">
    ...
    <table>
      <thead>
        ...
        $result = mysqli_query($db_connection, "SELECT * FROM `monster_list`");
        
        while($row = mysqli_fetch_array($result)) {
          echo "<tbody><tr><td>" . $row["nomor"] . "</td><td>" . $row["nama_musuh"] . "</td><td>" . $row["status"] . "</td><td>" . $row["link"] . "</td></tr></tbody>";
        }
        echo "</table>";
